...
describe 'hello', ->
  ...
  describe 'listeners[0].regex', ->
    describe 'valid patterns', ->
      beforeEach ->
        @tests = [
          message: '@hubot firmata-led on'
          matches: ['@hubot firmata-led on', 'on']
        ,
          message: '@hubot firmata-led off '
          matches: ['@hubot firmata-led off ', 'off']
        ]
  ...
  describe 'robot.helpCommands()', ->
    it '''
    should be ["hubot firmata-led <on|off> - set the LED by firmata protocol"]
    ''', ->
